...
import static com.rm.common.core.exception.ServiceStatusCode.ERROR_NOT_EXISTS;
	...
	protected void renderBody(Object data, int rowIndex, int columnStartIndex) {
		...
		for (String dataFieldName : resource.getDataFieldNames()) {
			...
			try {
				...
				throw new RmCommonException(ERROR_EXCEL, ERROR_NOT_EXISTS, "cell body is failed!!");
			}
		}
	}
